...
def greeting():
    ...
    if hour >= 0 and hour <= 12:
        speak("Good morning, Sadat. How can I help you?")
    elif hour > 12 and hour <= 18:
        speak("Good afternoon, Sadat. How can I help you?")
    else:
        speak("Good night, Sadat. How can I help you?")
...
def close_tab():
    ...
    try:
        ...
        speak("Closed the active tab.")
        logging.info("Closed active Chrome tab")
    except Exception as e:
        speak("Unable to close the tab.")
...
def gemini_model_response(user_input):
    ...
    """
    GEMINI_API_KEY = "AIzaSyApWvLKc6e1kQ4buRYD5jbNkHNr-lBXQRM"
    genai.configure(api_key=GEMINI_API_KEY)
    model = genai.GenerativeModel("gemini-2.5-flash")
    prompt = f"You are Sifra, act as Sifra a voice assistant for sadat. Answer the provided question too shortly in 1 or 2 line. the question is {user_input}"
...
while True:
    ...
    if "your name" in query or "who are you" in query:
        speak("I'm Sifra, made with love by, Sadat.")
        ...
        try:
            ...
            print(f"Error: {e}")
            logging.error("Gemini response is not working.")
